...
access_token_key = "1320296472-5LBsEQ106bHNpl7TK5Cyj2eiUEsAXqesg31ZS4B"
access_token_secret = "AAuVQ2oh8ld7OhBBAgMQf0CPRel26nSciWeSHDehGWDIf"

consumer_key = "m4KySInjxMhhgu5psZep6RYGx"
consumer_secret = "Ex5D5SutFVxlu05D3wmL9ycKqxxjnPVOEKtK5BaL1qiNeSx2L5"
...
def fetch_by_terms(term):
    ...
    parameters = [("q", term),("count", 200)]
    response = twitterreq(url, "GET", parameters)
    f = open('search_output_sanilk2.txt', 'w')
    for line in response:
        tweets = json.loads(line.strip().decode('utf-8'))
